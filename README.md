...
| `#/` | CounterPage | 六車種手機計數主畫面，固定 `100dvh` |
| `#/feedback` | FeedbackSettingsPage | 獨立設定增加、減少、負數錯誤的震動與音效 |
| `#/export` | ExportPage | AG Grid 原始資料、合計、統計與 CSV 匯出 |
...
- 漢堡選單：匯出與統計、編輯路段／使用者、震動與音效、使用手冊、版本變更說明、更改主題、清除本機資料。
- 10 款手機優先主題；包含 2×3、1×6、非對稱資訊牆與 2－3－1 鍵盤。
...
| 主題 | 適用情境 | 版面 |
| --- | --- | --- |
| 標準藍白 | 一般用途、清爽卡片 | 2×3／橫向 3×2 |
| 夜間高對比 | 深灰低眩光 | 2×3／橫向 3×2 |
| 清單大字 | 單欄與超大數字 | 1×6 |
| 戶外螢光 | 強日照、高反差 | 2×3／橫向 3×2 |
| 海洋藍綠 | 長時間觀看 | 2×3／橫向 3×2 |
| 暖陽珊瑚 | 暖色辨識 | 2×3／橫向 3×2 |
| 黑白工程 | 工程儀表與紙本表格感 | 2×3／橫向 3×2 |
| 霓虹控制台 | 夜間鮮明辨識 | 2×3／橫向 3×2 |
| 非對稱資訊牆 | 常用車種放大 | 2 張全寬＋4 張雙欄 |
| 錯位鍵盤 | 類大型硬體鍵盤 | 2－3－1 錯位布局 |
